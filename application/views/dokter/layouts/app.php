...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <?php $this->load->view('dokter/layouts/_sidebar') ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <?php $this->load->view('dokter/layouts/_navbar') ?>

        <!-- Begin Page Content -->
        <?php $this->load->view('dokter/pertanyaan/'. $page) ?>

      </div>
      <!-- End of Main Content -->

      <!-- Footer -->
      <?php $this->load->view('dokter/layouts/_footer') ?>
  ...
  <?php 
    if(isset($datatable)){
      $this->load->view('dokter/pertanyaan/'. $datatable);
    }
  ?>
